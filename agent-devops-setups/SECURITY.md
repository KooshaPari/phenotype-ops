...
We provide security updates for the following versions of **agent-devops-setups**:
...
We take the security of **agent-devops-setups** seriously. If you discover a security vulnerability, please do NOT open a public issue. Instead, report it privately.
